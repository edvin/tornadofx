...
fun ObservableValue<String>.matches(pattern: Regex): BooleanBinding = booleanBinding { it?.matches(pattern) == true }
...
// FIXME Inconsistency between `observable()` for KProperty1 and for KMutableProperty1

/** Convert an owner instance and a corresponding property reference into an observable */
fun <S, T> S.observable(prop: KMutableProperty1<S, T>): ObjectProperty<T> = observable(this, prop)
...
inline fun <reified T : Any> Any.observable(propName: String): ObjectProperty<T> = observable(propertyName = propName, propertyType = T::class)
...
enum class SingleAssignThreadSafetyMode { SYNCHRONIZED, NONE }
...
operator fun <T> ObservableValue<T>.getValue(thisRef: Any, property: KProperty<*>) = value // FIXME The return type should be `T` but it may break existing code
...
operator fun IntegerProperty.setValue(thisRef: Any, property: KProperty<*>, value: Int): Unit = set(value)

operator fun ObservableLongValue.getValue(thisRef: Any, property: KProperty<*>): Long = get()
operator fun LongProperty.setValue(thisRef: Any, property: KProperty<*>, value: Long): Unit = set(value)

operator fun ObservableFloatValue.getValue(thisRef: Any, property: KProperty<*>): Float = get()
operator fun FloatProperty.setValue(thisRef: Any, property: KProperty<*>, value: Float): Unit = set(value)

operator fun ObservableDoubleValue.getValue(thisRef: Any, property: KProperty<*>): Double = get()
operator fun DoubleProperty.setValue(thisRef: Any, property: KProperty<*>, value: Double): Unit = set(value)

operator fun ObservableBooleanValue.getValue(thisRef: Any, property: KProperty<*>): Boolean = get()
operator fun BooleanProperty.setValue(thisRef: Any, property: KProperty<*>, value: Boolean): Unit = set(value)
...
operator fun ObservableIntegerValue.rangeTo(other: Int): Sequence<IntegerProperty> = get().rangeTo(other).asSequence().map(::SimpleIntegerProperty)
...
operator fun ObservableIntegerValue.rangeTo(other: Long): Sequence<LongProperty> = get().rangeTo(other).asSequence().map(::SimpleLongProperty)
...
operator fun ObservableIntegerValue.compareTo(other: Number): Int = get().compareTo(other.toDouble())
operator fun ObservableIntegerValue.compareTo(other: ObservableNumberValue): Int = get().compareTo(other.doubleValue())
...
operator fun ObservableLongValue.rangeTo(other: Long): Sequence<LongProperty> = get().rangeTo(other).asSequence().map(::SimpleLongProperty)
...
operator fun ObservableLongValue.rangeTo(other: Int): Sequence<LongProperty> = get().rangeTo(other).asSequence().map(::SimpleLongProperty)
operator fun ObservableLongValue.rangeTo(other: ObservableIntegerValue): Sequence<LongProperty> =
    get().rangeTo(other.get()).asSequence().map(::SimpleLongProperty)


operator fun ObservableLongValue.compareTo(other: Number): Int = get().compareTo(other.toDouble())
operator fun ObservableLongValue.compareTo(other: ObservableNumberValue): Int = get().compareTo(other.doubleValue())
...
operator fun ObservableFloatValue.compareTo(other: Number): Int = get().compareTo(other.toFloat())
operator fun ObservableFloatValue.compareTo(other: ObservableNumberValue): Int = get().compareTo(other.floatValue())
...
operator fun ObservableDoubleValue.compareTo(other: Number): Int = get().compareTo(other.toDouble())
operator fun ObservableDoubleValue.compareTo(other: ObservableNumberValue): Int = get().compareTo(other.doubleValue())
...
operator fun StringExpression.get(index: Int): Binding<Char?> =
    objectBinding(this) { if (index < get().length) get()[index] else null }

operator fun StringExpression.get(index: ObservableIntegerValue): Binding<Char?> =
    objectBinding(this, index) { if (index < get().length) get()[index.get()] else null }
...
// fun String.toProperty(): StringProperty = SimpleStringProperty(this) // FIXME Shadows `String?.toProperty()`

fun Int?.toProperty(): IntegerProperty = SimpleIntegerProperty(this ?: 0)
fun Long?.toProperty(): LongProperty = SimpleLongProperty(this ?: 0L)
fun Float?.toProperty(): FloatProperty = SimpleFloatProperty(this ?: 0.0F)
fun Double?.toProperty(): DoubleProperty = SimpleDoubleProperty(this ?: 0.0)
fun Boolean?.toProperty(): BooleanProperty = SimpleBooleanProperty(this ?: false)
fun String?.toProperty(): StringProperty = SimpleStringProperty(this ?: "")
fun <T : Any> T?.toProperty(): ObjectProperty<T> = SimpleObjectProperty<T>(this)
// TODO Add `toNullableProperty()`
 ...
 */
@Suppress("UNCHECKED_CAST")
fun <K, V, X : V> MutableMap<K, V>.toProperty(key: K, propertyGenerator: (X?) -> Property<X>): Property<X> {
