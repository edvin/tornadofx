...
class PropertyDelegate<T>(val fxProperty: Property<T>) : ReadWriteProperty<Any, T> {
    private var prop: T by fxProperty
 ...
 */
@Suppress("UNCHECKED_CAST")
inline fun <reified S : Any, reified T : Any> S.observable(
...
operator fun DoubleProperty.inc(): DoubleProperty = ReadOnlyDoubleWrapper(value+1)
...
operator fun DoubleProperty.dec(): DoubleProperty = ReadOnlyDoubleWrapper(value-1)
...
operator fun FloatProperty.inc(): FloatProperty = ReadOnlyFloatWrapper(value+1)
...
operator fun FloatProperty.dec(): FloatProperty = ReadOnlyFloatWrapper(value-1)
...
operator fun IntegerProperty.inc(): IntegerProperty = ReadOnlyIntegerWrapper(value+1)
...
operator fun IntegerProperty.dec(): IntegerProperty = ReadOnlyIntegerWrapper(value-1)
...
operator fun LongProperty.inc(): LongProperty = ReadOnlyLongWrapper(value+1)
...
operator fun LongProperty.dec(): LongProperty = ReadOnlyLongWrapper(value-1)
