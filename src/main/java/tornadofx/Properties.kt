...
operator fun <E> ObservableListValue<E>.getValue(thisRef: Any, property: KProperty<*>): ObservableList<E> = value
operator fun <E> ListProperty<E>.setValue(thisRef: Any, property: KProperty<*>, list: List<E>) = set(FXCollections.observableList(list))

operator fun <E> ObservableSetValue<E>.getValue(thisRef: Any, property: KProperty<*>): ObservableSet<E> = value
operator fun <E> SetProperty<E>.setValue(thisRef: Any, property: KProperty<*>, set: Set<E>) = set(FXCollections.observableSet(set))

operator fun <K, V> ObservableMapValue<K, V>.getValue(thisRef: Any, property: KProperty<*>): ObservableMap<K, V> = value
