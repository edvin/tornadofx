...
open class Stylesheet : CssBlock() {
    companion object {
        ...
        internal val hover by csspseudoclass()
        internal val pressed by csspseudoclass()
        internal val disabled by csspseudoclass()
        internal val armed by csspseudoclass()
        internal val focused by csspseudoclass()
        internal val showMnemonics by csspseudoclass()

        // Style classes used by JavaFX
        internal val label by cssclass()
        internal val button by cssclass()
        internal val checkBox by cssclass()
        internal val choiceBox by cssclass()
        internal val comboBox by cssclass()
        internal val comboBoxBase by cssclass()
        internal val comboBoxPopup by cssclass()
        internal val imageView by cssclass()
        internal val dialogPane by cssclass()
        internal val mediaView by cssclass()
        internal val webView by cssclass()
        internal val accordion by cssclass()
        internal val cell by cssclass()
        internal val listCell by cssclass()
        internal val indexedCell by cssclass()
        internal val colorPicker by cssclass()
        internal val textInput by cssclass()
        internal val listView by cssclass()
        internal val contextMenu by cssclass()
        internal val arrowButton by cssclass()
        internal val arrow by cssclass()
        internal val menu by cssclass()
        internal val menuItem by cssclass()
        internal val menuBar by cssclass()
        internal val menuButton by cssclass()
        internal val passwordField by cssclass()
        internal val pagination by cssclass()
        internal val scrollArrow by cssclass()
        internal val datePicker by cssclass()
        internal val htmlEditor by cssclass()
        internal val leftContainer by cssclass()
        internal val rightContainer by cssclass()
        internal val graphicContainer by cssclass()
        internal val hyperlink by cssclass()
        internal val progressBar by cssclass()
        internal val progressIndicator by cssclass()
        internal val radioButton by cssclass()
        internal val scrollBar by cssclass()
        internal val scrollPane by cssclass()
        internal val separator by cssclass()
        internal val spinner by cssclass()
        internal val slider by cssclass()
        internal val splitMenuButton by cssclass()
        internal val splitPane by cssclass()
        internal val tabPane by cssclass()
        internal val columnHeader by cssclass()
        internal val tableView by cssclass()
        internal val textArea by cssclass()
        internal val textField by cssclass()
        internal val toggleButton by cssclass()
        internal val toolBar by cssclass()
        internal val tooltip by cssclass()
        internal val treeCell by cssclass()
        internal val treeTableCell by cssclass()
        internal val treeTableView by cssclass()
        internal val treeView by cssclass()
        internal val axis by cssclass()
        internal val axisMinorTickMark by cssclass()
        internal val chart by cssclass()
        internal val chartLegend by cssclass()
        internal val chartLegendItem by cssclass()
        internal val chartLegendSymbol by cssclass()
        internal val rootPopup by cssclass("root.popup")
        internal val headerPanel by cssclass()
        internal val content by cssclass()
        internal val buttonBar by cssclass()
        internal val firstTitledPane by cssclass()
    }
